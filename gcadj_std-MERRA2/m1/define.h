...
!==============================================================================
#if !defined(GEOS_3) && !defined(GEOS_4) && !defined(GEOS_5) && !defined(GEOS_FP) && !defined(MERRA2) && !defined(GCAP)
#error "ERROR: GEOS_3, GEOS_4, GEOS_5, GEOS-FP, MERRA2, and GCAP"
...
!==============================================================================
#if !defined(GRID2x25) && !defined(GRID4x5) && !defined(GRID1x125) && !defined(GRID1x1) && !defined(GRID05x0666) && !defined(GRID025x03125) && !defined(GRID05x0625)
#error "ERROR: GRID4x5, GRID2x25, GRID1x125, GRID05x0666, GRID05x0625,"
#error " and GRID1x1 are ALL undefined in header file define.h"
#endif
