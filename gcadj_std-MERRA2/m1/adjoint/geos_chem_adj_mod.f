...
#     include "define_adj.h"      ! Obs operators
      ...
      USE CHECKPT_MOD,       ONLY : MAKE_ADJ_FILE, MAKE_GDT_MULTI_FILE
      USE CHECKPT_MOD,       ONLY : MAKE_EMS_ADJ_FILE_ZZ1 !ZZ
      USE CHECKPT_MOD,       ONLY : MAKE_EMS_ADJ_FILE_ZZ2 !ZZ
      USE CHECKPT_MOD,       ONLY : MAKE_EMS_ADJ_FILE_ZZ3 !ZZ
