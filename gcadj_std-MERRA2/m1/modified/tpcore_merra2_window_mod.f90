...
module TPCORE_MERRA2_WINDOW_MOD
!
!******************************************************************************
...
!
  ...
  !%%%
  PRIVATE
  PUBLIC :: TPCORE_MERRA2_WINDOW
  PUBLIC :: INIT_MERRA2_WINDOW
  PUBLIC :: EXIT_MERRA2_TPCORE_WINDOW
  !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
!-------------------------------------------------------------------------
 subroutine init_MERRA2_WINDOW(im,jm,km,jfirst,jlast,ng, mg, dt, ae, clat)
!-------------------------------------------------------------------------
...
!----------------
 ...
 end subroutine init_MERRA2_WINDOW

!-------------------------------------------------------------------------
 subroutine EXIT_MERRA2_TPCORE_WINDOW
!-------------------------------------------------------------------------
 ...
 end subroutine EXIT_MERRA2_TPCORE_WINDOW


!----------------------------------------------------------------------------
 subroutine TPCORE_MERRA2_WINDOW( dt,    ae, im, jm, km, jfirst,         &
                                 jlast, ng, mg,                         &
...
!! (lzh, 05/20/2014, comment out poles)
!!$  if ( jfirst == 1 ) then
...
!$OMP END PARALLEL DO
 ...
 END subroutine TPCORE_MERRA2_WINDOW
...
!! (lzh, 05/20/2014, not treat edges)
!!$   do j=js2g0,jn2g0
!!$      do i=1,im-1
...
! Poles: (lzh, 05/20/2014, comment out poles)
! Poles:
    if ( jfirst == 1 ) then
       do i=1,im
...
end module TPCORE_MERRA2_WINDOW_MOD
