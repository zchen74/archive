...
! $Id: pjc_pfix_geos5_window_mod.f,v 1.1 2011/02/23 00:08:48 daven Exp $
      MODULE PJC_PFIX_MERRA2_WINDOW_MOD
!
!******************************************************************************
...
#     include "define.h"
      ...
      PUBLIC :: CLEANUP_PJC_PFIX_MERRA2_WINDOW
      PUBLIC :: DO_PJC_PFIX_MERRA2_WINDOW
...
!------------------------------------------------------------------------------
      ...
      SUBROUTINE DO_PJC_PFIX_MERRA2_WINDOW( D_DYN, P1,   P2,
...
#     include "define.h"
     ...
     &                   XMASS,              YMASS )
      ...
      END SUBROUTINE DO_PJC_PFIX_MERRA2_WINDOW
...
!------------------------------------------------------------------------------
      ...
      SUBROUTINE CLEANUP_PJC_PFIX_MERRA2_WINDOW
!
!******************************************************************************
...
!
      ...
      ! Return to calling program
      END SUBROUTINE CLEANUP_PJC_PFIX_MERRA2_WINDOW

!------------------------------------------------------------------------------

      END MODULE PJC_PFIX_MERRA2_WINDOW_MOD
