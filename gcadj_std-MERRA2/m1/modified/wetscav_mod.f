...
!! geos-fp and merra (lzh,07/10/2014)
         ...
         !==============================================================
         ! %%%%% FOR GEOS-FP and MERRA2 MET FIELDS ONLY %%%%%
         !
         ! In GEOS-FP/MERRA2, the PFILSAN and PFLLSAN fields are defined
...
!$OMP+SCHEDULE( DYNAMIC )
     ...
     &                    AD17(I,J,L,NN,IDX) + RAINFRAC / F
                  ...
                  IF ( STT(I,J,L,N) < 0d0 ) THEN
                     IF ( STT(I,J,L,N) .LT. NEG_SMALL ) THEN
